...
def calculates_results_stats(results_dic):
    ...
    # Correct label regardless species
    #results_stats_dic['correct_labels'] = results_dic[key][2] = 1  
    #results_stats_dic['pct_correct_labels'] = results_stats_dic['correct_labels'] / 
